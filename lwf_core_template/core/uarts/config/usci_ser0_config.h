...
#define USCI_Ser0_RX_VECTOR_LOCATION	0					//< RX vector. Leave undefined for a shared vector with USCI B.
#define USCI_A0_RX_ISR					USCI_Ser0_RX_ISR	//< ISR name. Define for a shared vector with USCI B.
#define USCI_Ser0_TX_VECTOR_LOCATION	0					//< TX vector. Leave undefined for a shared vector with USCI B.
